...
const SingleBlog = ({ blog }: { blog: Blog }) => {
  ...
  return (
    <>
      <div className="group shadow-one hover:shadow-two dark:bg-[#1a0033]/40 dark:hover:shadow-gray-dark dark:backdrop-blur-3xl relative overflow-hidden rounded-2xl bg-white/80 backdrop-blur-md duration-300 border border-white/20 dark:border-white/10">
        <Link
          href="/blog-details"
            ...
            <div className="border-body-color/10 mr-5 flex items-center border-r pr-5 xl:mr-3 xl:pr-3 2xl:mr-5 2xl:pr-5 dark:border-white/10">
              <div className="mr-4">
                <div className="relative h-10 w-10 overflow-hidden rounded-full">
                  <Image
                    sizes="(max-width: 640px) 100vw, (min-width: 641px) 50vw"
                    src={author.image} alt="author" fill />
                </div>
              </div>
