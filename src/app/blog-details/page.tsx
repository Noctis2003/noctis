...
export const metadata: Metadata = {
  ...
  description: "This is Blog Details Page for Noctisgroup ",
  // other metadata
};
...
const BlogDetailsPage = () => {
  return (
    <>
      <section className="pt-[150px] pb-[120px] dark:bg-gradient-to-br dark:from-[#0d0d0d] dark:via-[#1a0033] dark:to-[#000000]">
            ...
            <div className="w-full px-4 lg:w-8/12">
              <div>
                <h2 className="mb-8 text-3xl leading-tight font-bold text-black sm:text-4xl sm:leading-tight dark:text-white">
                  Want to write your own micro blog?
                </h2>
                ...
                <div>
                  <p className="text-body-color mb-10 text-base leading-relaxed font-medium sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    Welcome to our blog! Here, we share insights, tips, and stories to help you grow your startup and succeed in the SaaS world. Stay tuned for expert advice and inspiring journeys from entrepreneurs who have built successful companies.
                  </p>
                  ...
                  <p className="text-body-color mb-8 text-base leading-relaxed font-medium sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    Building a successful startup requires more than just a great idea. It demands strategic planning, understanding your market, and creating products that solve real problems. Whether you&apos;re in the early stages of ideation or scaling your business, having the right 
                  
                      foundation
                    
                    is crucial for long-term success. From identifying your target audience to developing a sustainable business model, every decision shapes your startup&apos;s future trajectory.
                  </p>
                  <p className="text-body-color mb-10 text-base leading-relaxed font-medium sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    The startup ecosystem thrives on innovation and adaptability. 
                    
                      Successful entrepreneurs understand

                    that building a company is an iterative process requiring constant learning and refinement. From MVP development to product-market fit, each milestone brings new challenges and opportunities for growth.
                  </p>
                  <h3 className="font-xl mb-10 leading-tight font-bold text-black sm:text-2xl sm:leading-tight lg:text-xl lg:leading-tight xl:text-2xl xl:leading-tight dark:text-white">
                    Building Your SaaS Platform: Key Considerations
                  </h3>
                  <p className="text-body-color mb-10 text-base leading-relaxed font-medium sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    When developing a SaaS platform, focusing on user experience and scalability is essential. Your platform should solve specific pain points while providing an intuitive interface that customers love to use.
                  </p>
                  <ul className="text-body-color mb-10 list-inside list-disc">
                    <li className="text-body-color mb-2 text-base font-medium sm:text-lg lg:text-base xl:text-lg">
                      Focus on solving real customer problems with clear value propositions.
                    </li>
                    <li className="text-body-color mb-2 text-base font-medium sm:text-lg lg:text-base xl:text-lg">
                    ...
                    <li className="text-body-color mb-2 text-base font-medium sm:text-lg lg:text-base xl:text-lg">
                      Design intuitive user interfaces that reduce learning curves
                    </li>
                  </ul>
                  <div className="bg-primary/10 relative z-10 mb-10 overflow-hidden rounded-md p-8 md:p-9 lg:p-8 xl:p-9">
                    <p className="text-body-color text-center text-base font-medium italic">
                      &ldquo;The best startups are built by teams that understand their customers deeply and iterate quickly based on feedback. Success comes from solving real problems, not just building cool technology.&rdquo;
                    </p>
                  ...
                  <p className="text-body-color mb-10 text-base leading-relaxed font-medium sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    Remember that building a successful startup is a marathon, not a sprint. Focus on creating sustainable growth, building strong customer relationships, and continuously improving your product based on user feedback and market demands.
                  </p>
