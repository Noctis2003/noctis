...
export const metadata: Metadata = {
  title: "Error Page ",
  description: "This is Error Page for Noctisgroup ",
  // other metadata
};
...
const ErrorPage = () => {
  return (
    <>
      <section className="relative z-10 pb-16 pt-36 md:pb-20 lg:pb-28 lg:pt-[180px] dark:bg-gradient-to-br dark:from-[#0d0d0d] dark:via-[#1a0033] dark:to-[#000000]">
